...
class TripController extends AbstractController
{
    ...
    public function new(Request $request, GeoService $geoService): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $lat1 = $trip->getFromCity()->getLatitude();
            $lng1 = $trip->getFromCity()->getLongitude();
            $lat2 = $trip->getToCity()->getLatitude();
            $lng2 = $trip->getToCity()->getLongitude();
            $trip->setDistance($geoService->calcDistance($lat1, $lng1, $lat2, $lng2));
